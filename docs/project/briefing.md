...
`whatsapp-missas`. See [the API contract](../api.md) for shared-secret authorization,
pagination, and per-schedule verification/source semantics. Outreach and write-back
remain outside this server slice.
