...
app_name = "core"
migration_name = "0030_migrate_schedule_location_to_location_table"
...
def test_create_location(migrator):
    ...
    schedule = baker.make(OldSchedule)
    ...
    assert created_location.slug == slugify(schedule.location)
...
def test_location_with_multiple_schedules(migrator):
    ...
    schedule1 = baker.make(OldSchedule, location=location_name)
    ...
    assert created_location.slug == "main-church"
...
def test_multiple_parishes_in_the_same_city_with_the_same_location_name(migrator):
    ...
    OldSchedule = old_state.apps.get_model(app_name, "Schedule")
    location_name = "Main Church"
    schedule1 = baker.make(OldSchedule, location=location_name, parish__name="Parish 1")
    schedule2 = baker.make(OldSchedule, location=location_name, parish__city=schedule1.parish.city, parish__name="Parish 2")
...
# TODO: test schedule without .location
